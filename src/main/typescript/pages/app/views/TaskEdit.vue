          ...
          <validation-observer v-slot="{ invalid }">
            <b-card-text>
              ...
              <move-object-component
                  ...
                  :frozen-elem="task.parent == null ? { id: task.list.id, type: 'LIST' } : { id: task.parent.id, type: 'TASK' }"
...
import {GroupTree, MoveElemInfo, NavbarItem, Task, TaskEditInfo} from "@/models";
